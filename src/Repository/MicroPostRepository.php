...
class MicroPostRepository extends ServiceEntityRepository
{
    ...
    public function findAllWithComments(): array
    {
        ...
        return $this->findAllQuery(withComments: true)->getQuery()->getResult();  //to zastępuje powyższy zakomentowany kod
    }
    ...
    public function findAllByAuthor(int | User $author): array 
    {
        return $this->findAllQuery(
            ...
            withAuthors: true,
            withProfiles: true
        )->where('p.author = :author')->setParameter('author', $author instanceof User ? $author->getId() : $author)
        ->getQuery()
        ->getResult();
    }
